...
if($config->comments) {
    ...
    Weapon::add('SHIPMENT_REGION_BOTTOM', function() use($config) {
        if(Config::get('page_type') === 'article') {
            if( ! Asset::loaded('manager/sword/editor/editor.min.js')) {
                echo Asset::javascript('manager/sword/editor/editor.min.js');
            }
            if( ! Asset::loaded('manager/sword/editor/mte.min.js')) {
                echo Asset::javascript('manager/sword/editor/mte.min.js');
            }
            if( ! Asset::loaded('manager/sword/editor/hte.min.js')) {
                echo Asset::javascript('manager/sword/editor/hte.min.js');
            }
